	...
	this.addSnake=function(topOff,leftOff,moveSpeed,pieceSize) //adds another snake to the box
		{
			...
			//alert("first snake successfully brought to life!!");
			this.switchSnake(this.Snakes.length-1);
			var self=this;
			var index=this.curSnake;
			this.directions[this.curSnake]="R";
			this.timers[this.curSnake]=setInterval(
				function()
				{
